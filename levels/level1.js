const level1 = new Level(
  [
    ...
    new Jellyfish(1150, 200, 'lila'),
    new Jellyfish(1250, 200, 'lila'),
    ...
    new Jellyfish(3100, 320, 'pink'),
    new Jellyfish(3200, 280, 'pink'),
    new Jellyfish(3300, 240, 'pink'),
    new Jellyfish(3400, 200, 'pink'),
    new Jellyfish(3500, 160, 'pink'),
    new Jellyfish(3600, 120, 'pink'),
    new Jellyfish(3700, 80, 'pink'),
