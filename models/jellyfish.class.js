class Jellyfish extends MovableObject {
   ...
   * @param {string} type type of the jellyfish
   */
  animate(type) {
   ...
   * @param {string} type type of jellyfish
   * @returns images of type
   */
  ...
  /**
   * changes images by type for the dead ones
   * @param {string} type type of jellyfish
   * @returns images of type
   */
